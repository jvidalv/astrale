...
import {Button, Caption, Subheading, Surface, Text, Title, useTheme} from "react-native-paper";
...
const SubHeading = () => {
    ...
    return (
        <View style={{marginHorizontal: 20}}>
            <Title theme={{colors: {text: colors.primary}}} style={{textAlign: 'center'}}>Astrology guides</Title>
            <View style={{height: 10}}/>
            <Text style={{textAlign: 'center'}}>
                {i18n.t('Learn paragraph')}
            </Text>
        </View>
    )
};
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <ScrollViewFadeFirst element={<SubHeading/>} height={140}>
                <Surface style={[styles.surfaceRight, {backgroundColor: 'transparent', marginTop: 10}]}>
                    <View style={[StyleSheet.absoluteFill, {top: -25, opacity: .8}]}>
                        <Constellation color={colors.text + '3D'} dotColor={colors.accent} width={250} height={300}/>
                    </View>
                    <LinearGradient
                        ...
                        <View style={{flex: 1}}>
                            ...
                            <Caption theme={{colors: {text: '#FFFFFF'}}} style={{marginTop: -3}}>
                ...
                <Surface style={[styles.surfaceLeft, {backgroundColor: 'transparent', height: 140}]}>
                    <View style={[StyleSheet.absoluteFill, {right: 150, opacity: .4}]}>
                        <ConstellationSimple
                    ...
                    <LinearGradient
                        colors={['#81411a', '#81411a' + 'E6', '#81411a' + '3D', 'transparent']}
                        start={[0, 0]} end={[1, 0]}
                        ...
                        <View style={{flex: 1}}>
                            ...
                            <View style={{flex: 1, justifyContent: 'flex-end'}}>
                                <Button
                                    mode="contained" icon="lock-outline"
                ...
                <View style={{height: 20}}/>
                <Surface style={[styles.surfaceRight, {backgroundColor: 'transparent', height: 130}]}>
                    <View style={[StyleSheet.absoluteFill, {top: -25, opacity: .3}]}>
