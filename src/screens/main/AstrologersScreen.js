...
function AstrologersScreen({navigation}) {
    ...
    const dummy_astrologist = [
        ...
        },
        {
            ...
            stars: 5,
            reviews: 120,
            photo: 'https://images.pexels.com/photos/1154059/pexels-photo-1154059.jpeg',
        },
        {
            id: 3,
            name: 'Xian Ju',
        ...
        },
        {
            ...
            stars: 4,
            reviews: 69,
            photo: 'https://static2.abc.es/media/estilo/2019/08/15/john-kiwE--620x349@abc.jpg',
        },
        {
            id: 6,
            name: 'Luffy',
            ...
            stars: 5,
            reviews: 976,
            photo: 'https://sites.google.com/site/heroespoderosos/_/rsrc/1397058950773/home/Estatua_de_cera_de_Luffy.png?height=330&width=400',
        },
    ]
                        ...
                        <View style={{marginTop: 10}}>
                            ...
                            <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                ...
                                <Text style={{
                                    marginLeft: 15,
                                    fontSize: 12
                                }}>{i18n.t('Wait ~24 hours for the response')}</Text>
                            </View>
                        </View>
                    </View>
                )}
                                ...
                                <React.Fragment key={id}>
                                    <TouchableRipple onPress={() => navigation.navigate('Question', {
                                        ...
                                        <React.Fragment>
                                            ...
                                            >
                                                <Title theme={{colors: {text: '#FFFFFF'}}}>{name}</Title>
                                            </LinearGradient>
                                            <Subheading theme={{colors: {text: '#FFFFFF'}}} style={[
                                            ...
                                            <View
                                                style={[styles.astrologistDetailsContainer, {borderColor: astrologist_colors[school]}]}>
                                                <Text style={{fontSize: 10,}}>{years_exp} other years experience</Text>
                                                <View style={styles.astrologistStars}>
                                                    <MaterialCommunityIcons name='star' color='gold'/>
                                                    <MaterialCommunityIcons name='star' color='gold'/>
                                                    <MaterialCommunityIcons name='star' color='gold'/>
                                                    <MaterialCommunityIcons name='star' color='gold'/>
                                                    <MaterialCommunityIcons name={stars === 5 ? 'star' : 'star-half'}
                                                                            color='gold'/>
                                                    <Text
                                                        style={styles.astrologistReview}>{reviews}</Text>
                                                </View>
                                            </View>
                                        </React.Fragment>
                                    </TouchableRipple>
                                    {i + 1 % 2 === 0 ? <View style={{width: '100%', height: 50}}/> : null}
                                </ React.Fragment>
                            )
                        )}
                </View>
...
const styles = StyleSheet.create({
    ...
    astrologistImage: {
        height: 150, borderTopLeftRadius: 25, borderTopRightRadius: 25
    },
    astrologistGradient: {
        marginTop: -34, paddingLeft: 10
    },
