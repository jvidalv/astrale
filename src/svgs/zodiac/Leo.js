...
function Leo({color, height, width, style}) {
    return (
        <Svg height={height} width={width} viewBox="0 0 512 512" style={style}>
            ...
            <G fill="#b267ba">
                <Path
                    d="M142.77 143.86l2.367-15.824 30.002 4.49-2.368 15.824zM129.88 183.387l6.272-14.72 27 11.504-6.273 14.72zM138.712 221.924l10.752-11.857 21.509 19.505-10.753 11.857zM100.712 228.002l12.432-10.064 16.995 20.993-12.432 10.064zM140.359 265.195l12.24-10.304 15.996 19.002-12.24 10.304zM185.242 231.236l7.376-14.192 25.986 13.505-7.376 14.192zM175.65 191.495l5.44-15.04 28.99 10.486-5.44 15.04zM206.142 151.853l3.888-15.52 31.995 8.016-3.888 15.52zM112 96h24v16h-24z"/>
            </G>
            <Path
